 ...
 * 汽车站首页(就是车站)
 */
@Route(path= BRouterPath.MAINPAGE_QICHEZHAN)
public class QiCheZhanHomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(QiCheZhanHomeActivity.this, BatteryService.class)), 1000);
    ...
    List<RobotMenuListBean.ResultBean.MenulistBean> getDefaultMenu() {
        ...
        menu.setMenuName(getString(R.string.consultation_service));
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(QiCheZhanHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//                actClass = XianYangEntertainmentActivity.class;
            ...
            } else if (name.equals(getString(R.string.consultation_service))) {
                BRouter.sync(getString(R.string.consultation_service));
                return;
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    QiCheZhanHomeActivity.this).inflate(R.layout.item_xiedian_list, parent,
                    false));
        }
...
//        }
    ...
    private boolean childPageCheck(String text){
        if (text.contains(getString(R.string.nav_service))) {
            ...
            actClass = NearByActivity.class;
        } else if (text.contains(getString(R.string.consultation_service))) {
            BRouter.sync(getString(R.string.consultation_service));
            return true;
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(QiCheZhanHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(QiCheZhanHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(QiCheZhanHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
