 ...
 * 科技馆首页
 */
@Route(path= BRouterPath.MAINPAGE_KEJIGUAN)
public class KeJiGuanHomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(KeJiGuanHomeActivity.this, BatteryService.class)), 1000);
    ...
    List<RobotMenuListBean.ResultBean.MenulistBean> getDefaultMenu() {
        ...
        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.nav_explain));
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(KeJiGuanHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//        speak(ssb.toString());
    ...
    private OnItemClickListener itemClickListener = new OnItemClickListener() {
        ...
        public void itemClick(int position) {
            ...
            if (name.equals(getString(R.string.nav_explain))) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    KeJiGuanHomeActivity.this).inflate(R.layout.item_jiaju_list, parent,
                    false));
        }
...
//        }
    ...
    private boolean childPageCheck(String text){
        if (text.contains(getString(R.string.nav_explain))) {
            BlackgagaLogger.debug("isloadMap" + isLoadMapSuccess);
            if (!isLoadMapSuccess) {
                restoreMapDialog();
            } else {
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(KeJiGuanHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(KeJiGuanHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(KeJiGuanHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
