 ...
 * 前台首页
 */
@Route(path= BRouterPath.MAINPAGE_QIANTAI)
public class QianTaiHomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(QianTaiHomeActivity.this, BatteryService.class)), 1000);
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(QianTaiHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//                actClass = XianYangEntertainmentActivity.class;
                ...
                BRouter.sync(getString(R.string.service_introduce));
                return ;
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    QianTaiHomeActivity.this).inflate(R.layout.item_airporthome_list, parent,
                    false));
        }
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(QianTaiHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(QianTaiHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(QianTaiHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
