...
//import com.csjbot.blackgaga.advertisement.Constants;
//import com.csjbot.blackgaga.advertisement.service.AdvertisementService;
...
// * 税务主页
// */
////@Route(path = BRouterPath.MAINPAGE_SHUIWU)
//public class ShuiWuHomeActivity extends BaseFullScreenActivity {
...
//    @BindView(R.id.nav_shuiwu)
//    RelativeLayout mNavShuiwu;
//    @BindView(R.id.services_shuiwu)
//    RelativeLayout mServicesShuiwu;
//    @BindView(R.id.peripheral_services_shuiwu)
//    RelativeLayout mPeripheralServicesShuiwu;
//    @BindView(R.id.administrative_consulting_shuiwu)
//    RelativeLayout mAdministrativeConsultingShuiwu;
//
...
//        loadData();
//
//        new Handler().postDelayed(() -> startService(new Intent(ShuiWuHomeActivity.this, BatteryService.class)), 1000);
...
//
//            if (current != null) {
//                speak(current.getName() + "已经带到，我要回去了，如需要其他帮助请去找我，谢谢。", new OnSpeakListener() {
//                    @Override
...
//                        startActivity(new Intent(ShuiWuHomeActivity.this, NaviGuideCommentActivity.class));
//                    }
//                });
//            }
//        }
...
//                sendMoveForward();
//                if(person) {
//                    setAdvertisementAction(Constants.ADVERTISEMENT_HIDE);
//                    advertisementHandler.removeCallbacks(advertisementRb);
//                }else{
//                    advertisementHandler.postDelayed(advertisementRb,20000);
//                }
...
//        return R.layout.activity_shuiwu_home;
//    }
//
//    @Override
...
//    }
//
//    @OnClick({R.id.nav_shuiwu, R.id.services_shuiwu, R.id.peripheral_services_shuiwu, R.id.administrative_consulting_shuiwu})
//    public void onViewClicked(View view) {
//        switch (view.getId()) {
//            case R.id.nav_shuiwu:
//                goNaviAct();
//                break;
//            case R.id.services_shuiwu:
////                BRouter.jumpActivity(BRouterPath.INFO_SEARCH);
//                BRouter.jumpActivityByContent("促销活动");
//                break;
//            case R.id.peripheral_services_shuiwu:
//                goNearByAct();
//                break;
//            case R.id.administrative_consulting_shuiwu:
//                BRouter.jumpActivityByContent("酒店介绍");
//                break;
//        }
//    }
//
...
//    ////                    ChemistHomeActivity.this).inflate(R.layout.item_home_list, parent,
//    ////                    false));
//    ////        }
//    //
...
//            runOnUiThread(() -> {
//                if (!isFinish) {
//                    Toast.makeText(ShuiWuHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
//                }
//            });
...
//                Toast.makeText(ShuiWuHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
//                jumpActivity(NaviActivity.class);
//            } else {
//                Toast.makeText(ShuiWuHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
//            }
//        });
//    }
//
