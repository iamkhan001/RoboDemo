 ...
 * 电器首页
 */
@Route(path= BRouterPath.MAINPAGE_JIADIAN)
public class JiaDianHomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(JiaDianHomeActivity.this, BatteryService.class)), 1000);
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(JiaDianHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    JiaDianHomeActivity.this).inflate(R.layout.item_home_list, parent,
                    false));
        }
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(JiaDianHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(JiaDianHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(JiaDianHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
