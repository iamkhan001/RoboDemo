 ...
 * 手机首页
 */
@Route(path = BRouterPath.MAINPAGE_SHOUJI)
public class ShouJiHomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(ShouJiHomeActivity.this, BatteryService.class)), 1000);
...
//
//        menu = new RobotMenuListBean.ResultBean.MenulistBean();
//        menu.setMenuName(getString(R.string.discount));
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(ShouJiHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//            } else if (name.equals(getString(R.string.discount))) {
//                BRouter.sync(getString(R.string.discount));
//                return;
                ...
                return;
                //            } else if (name.equals(getString(R.string.aboutus))) {
                //                actClass = CompanyiIntroductionActivity.class;
    ...
    public int getLayoutId() {
        return getCorrectLayoutId(R.layout.activity_home, R.layout.vertical_activity_shouji_home);
    }
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    ShouJiHomeActivity.this).inflate(R.layout.item_shouji_list, parent,
                    false));
        }
    ...
    private boolean childPageCheck(String text) {
        if (text.contains(getString(R.string.nav_service))) {
            ...
            actClass = NearByActivity.class;
//        } else if (text.contains(getString(R.string.discount))) {
//            BRouter.sync(getString(R.string.discount));
//            return true;
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(ShouJiHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(ShouJiHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(ShouJiHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
