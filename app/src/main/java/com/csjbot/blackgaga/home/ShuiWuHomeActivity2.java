...
//public class ShuiWuHomeActivity2 extends BaseMainPageActivity {
//
...
//        loadData();
//
//        new Handler().postDelayed(() -> startService(new Intent(ShuiWuHomeActivity2.this, BatteryService.class)), 1000);
...
//                        startActivity(new Intent(ShuiWuHomeActivity2.this, NaviGuideCommentActivity.class));
//                    }
//                });
//            }
//        }
...
//            return new MyViewHolder(LayoutInflater.from(ShuiWuHomeActivity2.this).
...
//            runOnUiThread(() -> {
//                if (!isFinish) {
//                    Toast.makeText(ShuiWuHomeActivity2.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
//                }
//            });
...
//                Toast.makeText(ShuiWuHomeActivity2.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
//                jumpActivity(NaviActivity.class);
//            } else {
//                Toast.makeText(ShuiWuHomeActivity2.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
//            }
//        });
//    }
//
