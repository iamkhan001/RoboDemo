 ...
 * 新教育首页
 */
@Route(path= BRouterPath.MAINPAGE_JIAOYU2)
public class JiaoYu2HomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(JiaoYu2HomeActivity.this, BatteryService.class)), 1000);
    ...
    List<RobotMenuListBean.ResultBean.MenulistBean> getDefaultMenu() {
        ...
        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.study_encyclopedia));
        ...
        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.course_education));
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(JiaoYu2HomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//        speak(ssb.toString());
    ...
    private OnItemClickListener itemClickListener = new OnItemClickListener() {
        ...
        public void itemClick(int position) {
            ...
            if (name.equals(getString(R.string.nav))) {
            ...
            } else if (name.equals(getString(R.string.course_education))) {
                ...
                return;
            } else if (name.equals(getString(R.string.study_encyclopedia))) {
                actClass = LearningEducationActivity.class;
            }
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    JiaoYu2HomeActivity.this).inflate(R.layout.item_home_list, parent,
                    false));
        }
...
//        }
    ...
    private boolean childPageCheck(String text){
        if (text.contains(getString(R.string.nav))) {
            ...
            actClass = EntertainmentActivity.class;
        } else if (text.contains(getString(R.string.course_education))) {
            BRouter.sync(getString(R.string.course_education));
            return true;
        } else if (text.contains(getString(R.string.study_encyclopedia))) {
            actClass = LearningEducationActivity.class;
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(JiaoYu2HomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(JiaoYu2HomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(JiaoYu2HomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
