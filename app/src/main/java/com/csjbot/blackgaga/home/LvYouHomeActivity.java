 ...
 * 旅游首页
 */
@Route(path= BRouterPath.MAINPAGE_LVYOU)
public class LvYouHomeActivity extends BaseMainPageActivity {
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(LvYouHomeActivity.this, BatteryService.class)), 1000);
    ...
    List<RobotMenuListBean.ResultBean.MenulistBean> getDefaultMenu() {
        ...
        menu.setMenuName(getString(R.string.nav_service));
        menu.setMImg(String.valueOf(R.drawable.iv_navigation));
        menus.add(menu);

        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.scenic_spot_introduction));
        ...
        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.product_introduction));
        menu.setMImg(String.valueOf(R.drawable.iv_product));
        menus.add(menu);


        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.promotional_campaign));
        ...
        menu = new RobotMenuListBean.ResultBean.MenulistBean();
        menu.setMenuName(getString(R.string.interactive_entertainment));
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(LvYouHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//        speak(ssb.toString());
    ...
    private OnItemClickListener itemClickListener = new OnItemClickListener() {
        ...
        public void itemClick(int position) {
            ...
            if (name.equals(getString(R.string.nav_service))) {
            ...
            } else if (name.equals(getString(R.string.promotional_campaign))) {
                BRouter.sync(getString(R.string.promotional_campaign));
                return;
//                actClass = XianYangEntertainmentActivity.class;
            } else if (name.equals(getString(R.string.product_introduction))) {
                actClass = ProductListActivity.class;
            } else if (name.equals(getString(R.string.local_service))) {
                actClass = NearByActivity.class;
            } else if (name.equals(getString(R.string.scenic_spot_introduction))) {
                BRouter.sync(getString(R.string.scenic_spot_introduction));
                return;
            } else if (name.equals(getString(R.string.aboutus))) {
                BRouter.sync(getString(R.string.aboutus));
                return;
            } else if (name.equals(getString(R.string.member_registration))) {
                actClass = VipCenterActivity.class;
            } else if (name.equals(getString(R.string.interactive_entertainment))) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(
                    LvYouHomeActivity.this).inflate(R.layout.item_xiedian_list, parent,
                    false));
        }
...
//        }
    ...
    private boolean childPageCheck(String text){
        if (text.contains(getString(R.string.nav_service))) {
            BlackgagaLogger.debug("isloadMap" + isLoadMapSuccess);
            if (!isLoadMapSuccess) {
                restoreMapDialog();
            } else {
        ...
        } else if (text.contains(getString(R.string.promotional_campaign))) {
             BRouter.sync(getString(R.string.promotional_campaign));
            return true;
        } else if (text.contains(getString(R.string.product_introduction))) {
            actClass = ProductListActivity.class;
//            BRouter.sync(getString(R.string.product_introduction));
            ...
            actClass = EntertainmentActivity.class;
        } else if (text.contains(getString(R.string.scenic_spot_introduction)) || text.contains("介绍一下你们的景点")) {
            BRouter.sync(getString(R.string.scenic_spot_introduction));
            return true;
    ...
    private void checkConnect() {
        mRecyclerView.postDelayed(() -> {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (!isFinish) {
                        Toast.makeText(LvYouHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (isState) {
                    ...
                    Toast.makeText(LvYouHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                    jumpActivity(NaviActivity.class);
                } else {
                    Toast.makeText(LvYouHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
