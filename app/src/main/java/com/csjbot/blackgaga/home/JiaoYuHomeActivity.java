...
//import com.csjbot.blackgaga.feature.Learning.LearningEducationActivity;
//import com.csjbot.blackgaga.feature.aboutus.AboutUsActivity;
//import com.csjbot.blackgaga.feature.coupon.CouponActivity;
//import com.csjbot.blackgaga.feature.entertainment.EducationActivity;
...
// * 教育首页
// */
//@Route(path = BRouterPath.MAINPAGE_JIAOYU)
//public class JiaoYuHomeActivity extends BaseFullScreenActivity {
//    @BindView(R.id.language)
//    LinearLayout mLanguage;
//
//
//    Class<? extends Activity> actClass;
//    @BindView(R.id.iv_nav_education)
//    ImageView mIvNavEducation;
//    @BindView(R.id.iv_learning_education)
//    ImageView mIvLearningEducation;
//    @BindView(R.id.iv_fun_education)
//    ImageView mIvFunEducation;
//    @BindView(R.id.iv_course_education)
//    ImageView mIvCourseEducation;
//    @BindView(R.id.iv_about_jiaoyu)
//    ImageView mIvAboutJiaoyu;
//
//
...
//        loadData();
//
//        new Handler().postDelayed(() -> startService(new Intent(JiaoYuHomeActivity.this, BatteryService.class)), 1000);
...
//                        startActivity(new Intent(JiaoYuHomeActivity.this, NaviGuideCommentActivity.class));
//                    }
//                });
//            }
//        }
...
//        switch (lan) {
//            case "product_menu_jp":
//                mIvNavEducation.setImageDrawable(getDrawable(R.drawable.iv_navigation_jp));
//                mIvLearningEducation.setImageDrawable(getDrawable(R.drawable.iv_encyclopedia_jp));
//                mIvFunEducation.setImageDrawable(getDrawable(R.drawable.iv_entertainment_jp));
//                mIvCourseEducation.setImageDrawable(getDrawable(R.drawable.iv_courseintroduction_jp));
//                mIvAboutJiaoyu.setImageDrawable(getDrawable(R.drawable.iv_about_jiaoyu));
//                break;
//            case "product_menu_en":
//                mIvNavEducation.setImageDrawable(getDrawable(R.drawable.iv_navigation_en));
//                mIvLearningEducation.setImageDrawable(getDrawable(R.drawable.iv_encyclopedia_en));
//                mIvFunEducation.setImageDrawable(getDrawable(R.drawable.iv_entertainment_en));
//                mIvCourseEducation.setImageDrawable(getDrawable(R.drawable.iv_courseintroduction_en));
//                mIvAboutJiaoyu.setImageDrawable(getDrawable(R.drawable.iv_about_jiaoyu));
//                break;
//            default:
//                mIvNavEducation.setImageDrawable(getDrawable(R.drawable.iv_navigation_cn));
//                mIvLearningEducation.setImageDrawable(getDrawable(R.drawable.iv_encyclopedia_cn));
//                mIvFunEducation.setImageDrawable(getDrawable(R.drawable.iv_entertainment_cn));
//                mIvCourseEducation.setImageDrawable(getDrawable(R.drawable.iv_courseintroduction_cn));
//                mIvAboutJiaoyu.setImageDrawable(getDrawable(R.drawable.iv_about_jiaoyu));
//                break;
//        }
//    }
...
//        return R.layout.activity_jiaoyu_home;
//    }
//
//    @Override
...
//    }
//
//    @OnClick({R.id.iv_nav_education, R.id.iv_learning_education, R.id.iv_fun_education, R.id.iv_course_education,R.id.iv_about_jiaoyu})
//    public void onViewClicked(View view) {
//        switch (view.getId()) {
//            case R.id.iv_nav_education:
//                goNaviAct();
//                break;
//            case R.id.iv_learning_education:
//                goLearningEducation();
//
//                break;
//            case R.id.iv_fun_education:
//                goEntertainmentAct();
//                break;
//            case R.id.iv_course_education:
//                BRouter.sync(getString(R.string.course_education));
//                break;
//            case R.id.iv_about_jiaoyu:
//                BRouter.sync(getString(R.string.aboutus));
//                break;
//            default:
//                break;
//        }
...
//            goNaviAct();
//            return true;
//        }else if(text.contains("学习百科")){
//            goLearningEducation();
//            return true;
//        }else if(text.contains("娱乐")){
//            goEntertainmentAct();
//            return true;
//        }else if(text.contains("课程介绍")){
//            BRouter.sync(getString(R.string.course_education));
//            return true;
//        }else if(text.contains("关于我们")){
//            BRouter.sync(getString(R.string.aboutus));
//            return true;
//        }
//
...
//    }
//
//    private void goLearningEducation() {
//        jumpActivity(LearningEducationActivity.class);
//    }
//    public void goEntertainmentAct() {
//        jumpActivity(EducationActivity.class);
//    }
//
...
//            runOnUiThread(() -> {
//                if (!isFinish) {
//                    Toast.makeText(JiaoYuHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
//                }
//            });
...
//                Toast.makeText(JiaoYuHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
//                jumpActivity(NaviActivity.class);
//            } else {
//                Toast.makeText(JiaoYuHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
//            }
//        });
//    }
//
