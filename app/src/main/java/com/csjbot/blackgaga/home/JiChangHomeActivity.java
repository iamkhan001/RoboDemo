...
public class JiChangHomeActivity extends BaseMainPageActivity {
    ...
    @BindView(R.id.consultation_service_jichang)
    RelativeLayout mConsultationServiceJichang;
    @BindView(R.id.nav_jichang)
    RelativeLayout mNavJichang;
    @BindView(R.id.product_introduction_jichang)
    RelativeLayout mProductIntroductionJichang;
    @BindView(R.id.fun_jichang)
    RelativeLayout mFunJichang;
    @BindView(R.id.local_recommend_jichang)
    RelativeLayout mLocalRecommendJichang;
...
//        startService(new Intent(this, GetMessageService.class));
        ...
        new Handler().postDelayed(() -> startService(new Intent(JiChangHomeActivity.this, BatteryService.class)), 1000);
            ...
            if (current != null) {
                speak(current.getName() + getString(R.string.destination), new OnSpeakListener() {
                    ...
                    public void onCompleted(SpeechError speechError) {
                        startActivity(new Intent(JiChangHomeActivity.this, NaviGuideCommentActivity.class));
                    }
                });
            }
        }
...
//               reOpenThread();
    ...
    public int getLayoutId() {
        return R.layout.activity_jichang_home;
    }
    ...
    @OnClick({R.id.consultation_service_jichang, R.id.nav_jichang, R.id.product_introduction_jichang, R.id.fun_jichang, R.id.local_recommend_jichang})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.consultation_service_jichang:
                goSearchAct();
                break;
            case R.id.nav_jichang:
                goNaviAct();
                break;
            case R.id.product_introduction_jichang:
                goProductAct();
                break;
            case R.id.fun_jichang:
              goEntertainmentAct();
                break;
            case R.id.local_recommend_jichang:
                goNearByAct();
                break;
        }
    }
    ...
    public void goSearchAct() {
        jumpActivity(SearchActivity2.class);
    }
    ...
    private void checkConnect() {
        new Handler().postDelayed(() -> {
            runOnUiThread(() -> {
                if (!isFinish) {
                    Toast.makeText(JiChangHomeActivity.this, R.string.check_linux, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void restoreMapResult(boolean isState) {
        runOnUiThread(() -> {
            ...
            if (isState) {
                ...
                Toast.makeText(JiChangHomeActivity.this, R.string.restore_map_success, Toast.LENGTH_LONG).show();
                jumpActivity(NaviActivity.class);
            } else {
                Toast.makeText(JiChangHomeActivity.this, R.string.restore_map_fail, Toast.LENGTH_LONG).show();
            }
        });
    }
