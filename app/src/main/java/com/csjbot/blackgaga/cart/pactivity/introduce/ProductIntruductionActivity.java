...
import com.csjbot.blackgaga.ai.ProductIntruductionAI;
...
public class ProductIntruductionActivity extends BaseModuleActivity implements ProductIntruductionContract.view, View.OnClickListener, ProductBoxAdapter.OnAddCatListener {
...
//        getTitleView().setCustomerServiceVisibility(View.VISIBLE);
    ...
    public SpannableStringBuilder getSpeakStr() {
        ...
        if (products != null && products.size() > 0) {
            ...
            richTextUtil.append("    " + getString(R.string.say_you_need_or_buy));
        }
    ...
    public void initRecy() {
        ...
        myAdapter.setListener(productBean -> {
            ...
            Intent intent = new Intent(ProductIntruductionActivity.this, ProductDetailActivity.class);
    ...
    protected boolean onSpeechMessage(String text, String answerText) {
        ...
        ProductIntruductionAI.Intent intent = mAI.getIntent(text);
        if (intent != null) {
    ...
    public <T> void add(T view, RobotSpListBean.ResultBean.ProductBean productBean) {
        ...
        if (getTitleView().getShoppingCart().getVisibility() == View.GONE ||
                getTitleView().getShoppingCart().getVisibility() == View.INVISIBLE) {
            presenter.addCartCount(productBean);
            return;
        }
