...
// */
//
//public class ProductIntruductionWithoutShoppingCartAI {
//}
package com.csjbot.blackgaga.ai;
...
public class ProductIntruductionWithoutShoppingCartAI extends AI<ProductIntruductionWithoutShoppingCartActivity>{

    public static ProductIntruductionWithoutShoppingCartAI newInstance(){
        return new ProductIntruductionWithoutShoppingCartAI();
    }
